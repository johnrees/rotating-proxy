FROM ubuntu:18.04
MAINTAINER John Rees <john@bitsushi.com>
...
RUN apt-get update && \
    apt-get install -y tor polipo haproxy ruby2.6 libssl-dev wget curl build-essential zlib1g-dev libyaml-dev libssl-dev && \
